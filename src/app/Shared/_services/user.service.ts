...
export class UserService {
  ...
  register (user: User) {
    return this.http.post<AuthResponseData>(
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCHMu50jb4R3iFJUbuvdqStBXXM1tMQ76A',
      {
        email: user.email,
  ...
  login(user: User) {
    return this.http.post<AuthResponseData>(
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCHMu50jb4R3iFJUbuvdqStBXXM1tMQ76A',
      {
        email: user.email,
        password: user.password,
        returnSecureToken: true
